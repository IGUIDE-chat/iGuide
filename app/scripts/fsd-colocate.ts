...
const fileMoves = [
    // Store
    { src: "/src/contexts/DormDataContext.tsx", dest: "/src/components/housing/store/DormDataContext.tsx" },
    { src: "/src/contexts/DormUserInteractionContext.tsx", dest: "/src/components/housing/store/DormUserInteractionContext.tsx" },
    { src: "/src/contexts/HousingContext.tsx", dest: "/src/components/housing/store/HousingContext.tsx" },

    // Hooks
    { src: "/src/hooks/useDormCommentStats.ts", dest: "/src/components/housing/hooks/useDormCommentStats.ts" },
    { src: "/src/hooks/useDormComments.ts", dest: "/src/components/housing/hooks/useDormComments.ts" },
    { src: "/src/hooks/useDormFilterBadge.ts", dest: "/src/components/housing/hooks/useDormFilterBadge.ts" },
    { src: "/src/hooks/useDormUserInteraction.ts", dest: "/src/components/housing/hooks/useDormUserInteraction.ts" },

    // Types
    { src: "/src/types/housing.ts", dest: "/src/components/housing/types/index.ts" },
];
