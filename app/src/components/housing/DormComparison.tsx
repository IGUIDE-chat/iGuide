      ...
      "
       ...
       "
          ...
          `}
               ...
               px-3 py-2.5 pr-8 text-sm font-medium text-gray-800
               focus:ring-2 focus:ring-illini-blue/30 focus:outline-none
             "
												>
													{plans.map((plan, i) => {
														const opt = {
             ...
             "
              ...
              `}
													>
														<div
															className="
                 flex shrink-0 items-center gap-1.5 text-sm text-gray-600
               "
														>
															{row.icon}
															<span>{row.label}</span>
														...
														<div className="text-right text-sm">
															...
															{isCheapest && (
																<span
																	className="
                   ml-1.5 rounded-full bg-emerald-100 px-1.5 py-0.5 text-[10px]
				...
				<table className="w-full min-w-[760px] border-collapse">
					<thead>
						<tr className="bg-gray-50">
							<th
								className="
          sticky left-0 z-10 border-r border-b border-gray-200 bg-gray-50 px-4
          py-3 text-left text-sm font-semibold text-gray-700
        "
							>
								{t.feature}
							</th>
							{dorms.map((dorm) => {
								...
								return (
									<th
										key={dorm.id}
										className="
            min-w-[220px] border-b border-gray-200 px-4 py-3 text-left text-sm
					...
					<tbody>
						{comparisonRows.map((row, rowIndex) => (
							...
							>
								<td
									className="
           sticky left-0 z-10 border-r border-b border-gray-200 bg-inherit p-4
       ...
       "
        ...
        "
						...
						>
							<div
								className="
          flex items-center border-r border-gray-200 bg-gray-50 px-4 py-3
									...
									>
										<div className="relative">
											<select
												...
												className="
              w-full cursor-pointer appearance-none rounded-lg border
              border-gray-200 bg-white px-3 py-2 pr-8 text-[13px] font-medium
              text-gray-800
              focus:border-illini-blue focus:ring-2 focus:ring-illini-blue/30
              focus:outline-none
            "
											>
												{plans.map((plan, i) => {
							...
							<tbody>
								{planRows.map((row, ri) => (
									...
									>
										<td
											className="
             sticky left-0 z-10 w-[140px] border-r border-b border-gray-200
             bg-inherit px-4 py-3 text-sm font-medium text-gray-600
           "
										>
