  ...
  return (
    <div className="flex h-full flex-col bg-gray-50">
      ...
      <div className="relative z-0 flex min-w-0 flex-1 flex-row overflow-hidden bg-gray-50/50">
        <div
          className={`h-full min-w-0 scrollbar-thin overflow-y-auto transition-opacity duration-200 ${
      ...
      <AnimatePresence>
        {compareIds.length > 0 && (
          <motion.div
            ...
            className="bg-illini-blue fixed inset-x-4 bottom-6 z-50 mx-auto flex w-fit max-w-[calc(100vw-2rem)] items-center gap-2 rounded-full px-3 py-2.5 text-white shadow-xl md:gap-3 md:px-5 md:py-3"
          >
