...
const DormUserInteractionContext =
  createContext<DormUserInteractionContextType | null>(null);

export const DormUserInteractionProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
...
export const useSharedDormInteraction = (): DormUserInteractionContextType => {
  ...
  if (!ctx) {
    throw new Error(
      "useSharedDormInteraction must be used within DormUserInteractionProvider"
    );
  }
  return ctx;
};
