...
import { ChevronLeft, ChevronRight, ThumbsUp, ExternalLink } from "lucide-react";
      ...
      {heroImage && (
        ...
        >
          ...
          {positivePercent !== null && (
            ...
            >
              <ThumbsUp className="size-3.5 fill-illini-orange text-illini-orange md:size-4" />
            ...
            <>
              <InlineImageNavButton
                ...
                onClick={(event) => {
                  ...
                  setHeroImageIndex((safeHeroImageIndex - 1 + heroImages.length) % heroImages.length);
                }}
              ...
              <InlineImageNavButton
                ...
                onClick={(event) => {
                  event.stopPropagation();
                  setHeroImageIndex((safeHeroImageIndex + 1) % heroImages.length);
                }}
