	...
	render() {
		...
		if (hasError) {
			return (
				<div
					className="
       flex size-full items-center justify-center bg-linear-to-br from-gray-50
       to-gray-100
     "
				>
	...
	return (
		<div ref={containerRef} className="relative size-full bg-gray-50">
			...
			>
				...
				<div
					className="
       absolute top-4 left-4 z-10 flex min-w-[140px] flex-col gap-2 rounded-lg
       border border-slate-200/50 bg-white/90 p-3 shadow-lg backdrop-blur-sm
     "
				>
					<div
						className="
