...
export const URH_OFFICIAL_OVERRIDES_SOUTH: Record<string, DormOverride> = {
    ...
    daniels: {
        ...
        description: 'Daniels Hall is a Green Street graduate and upper-division hall that stays open during university breaks and offers both academic-year and 12-month contracts, with individual-use and semi-private bathroom layouts.',
        pros: ['Academic-year and 12-month housing options', 'Walkable to Green Street and the engineering side of campus', 'Single and double room types with individual-use and semi-private baths'],
