/**
 * @file ./src/components/housing/constants/dormOfficialOverridesUrhSouth.ts
...
export const URH_OFFICIAL_OVERRIDES_SOUTH: Record<string, DormOverride> = {
  snyder: {
    ...
    description:
      'Snyder is a substance-free hall in Ikenberry Commons with quick access to SDRP dining, ARC, Memorial Stadium, and the School of Art + Design.',
    pros: [
      'Substance-free community environment',
      'Short walk to SDRP, ARC, and Memorial Stadium',
      'Standard, large double, and triple layouts',
    ],
    cons: [
      'No dining room inside the hall',
      'Traditional bathrooms are communal',
      'South-campus location is farther from north engineering',
    ],
    price: 13774,
  ...
  hopkins: {
    ...
    description:
      'Hopkins is a first-year-focused Ikenberry hall near ARC, Memorial Stadium, and SDRP dining, with a classic large-hall residential setup.',
    pros: [
      'Strong first-year residential programming',
      'Very close to ARC, Memorial Stadium, and SDRP',
      'Large double and triple options are available',
    ],
    cons: [
      'No dining room inside the hall',
      'Traditional bathrooms are communal',
      'South-campus location means longer walks to north-campus classes',
    ],
    price: 13774,
    bathroomType: 'communal',
    floorPlans: [
  ...
  weston: {
    ...
    description:
      'Weston is a social first-year hall in Ikenberry Commons and hosts both the Exploration and LEADS living-learning communities.',
    pros: [
      'Exploration and LEADS LLCs are based in Weston',
      'Close to SDRP, ARC, and Memorial Stadium',
      'Standard and triple layouts available',
    ],
    cons: [
      'No dining room inside the hall',
      'Communal bathrooms in standard layouts',
      'Longer walk to north-campus classrooms',
    ],
    price: 13774,
    bathroomType: 'communal',
    floorPlans: [
  ...
  scott: {
    ...
    description:
      'Scott Hall is home to the Transfer Community and balances a quieter residential atmosphere with immediate access to ARC and SDRP.',
    pros: [
      'Transfer Community on site',
      'Across the street from ARC and pool facilities',
      'SDRP dining and programs are close by',
    ],
    cons: [
      'No dining room in the hall',
      'Traditional bathrooms are communal',
      'North-campus classrooms are farther away',
    ],
    price: 13774,
    bathroomType: 'communal',
    floorPlans: [
  ...
  taft: {
    ...
    description:
      'Taft Hall is part of the historic Taft-Van Doren pair and offers quieter traditional housing close to SDRP, ARC, and the School of Art + Design.',
    pros: [
      'Historically one of the lower-cost University Housing options',
      'Quiet community feel near ARC and Siebel Center for Design',
      'Classic single and double room layouts',
    ],
    cons: [
      'No air conditioning',
      'No dining room inside the building',
      'Traditional bathrooms and older infrastructure',
    ],
    price: 14116,
    ac: false,
    bathroomType: 'communal',
  ...
  'van-doren': {
    ...
    description:
      'Van Doren Hall shares the quiet, historic Taft-Van Doren setting and is close to SDRP, ARC, and the design/art side of south campus.',
    pros: [
      'Lower-cost traditional University Housing option',
  ...
  daniels: {
    ...
    dining: 'nearby',
    diningNearbyDetail:
      'Daniels stays close to Green Street restaurants; University Housing publishes Daniels rates separately from meal plans.',
    categorizedTags: {
      livingConditions: [],
    ...
    description:
      'Daniels Hall is a Green Street graduate and upper-division hall that stays open during university breaks and offers both academic-year and 12-month contracts, with individual-use and semi-private bathroom layouts.',
    pros: [
      'Academic-year and 12-month housing options',
      'Walkable to Green Street and the engineering side of campus',
      'Single and double room types with individual-use and semi-private baths',
    ],
    cons: [
      'No dining room in the building',
      'Room and meal pricing are published separately',
      'Fewer room photos are published than for traditional halls',
    ],
    price: 8340,
    bathroomType: 'mixed',
    floorPlans: [
  ...
  sherman: {
    ...
    dining: 'nearby',
    diningNearbyDetail:
      'Sherman is walkable to campus restaurants and stays open over Fall, Winter, and Spring breaks.',
    categorizedTags: {
      livingConditions: [],
      facilities: ['laundry', 'studyLounge', 'kitchen', 'computerLab'],
      lifestyle: ['quiet', 'genderInclusive'],
    ...
    description:
      'Sherman Hall is a graduate and upper-division option close to the Main Quad and Campustown, and it remains open during Fall, Winter, and Spring breaks.',
    pros: [
      'Break housing is built into the hall calendar',
      'Close to the Main Quad and Campustown',
      'Single and double layouts are available',
    ],
    cons: [
      'No dining room in the building',
      'Room pricing is published separately from meal plans',
      'Shared bathrooms in standard layouts',
    ],
    price: 6906,
    bathroomType: 'communal',
    floorPlans: [
  ...
  lar: {
    ...
    description:
      'LAR (Leonard and Shelden) is a quieter hall community with in-hall dining, Scholars Community programming, and easy access to McKinley and CRCE.',
    pros: [
      'Dining is inside the LAR complex',
      'Close to McKinley and CRCE',
      'Scholars Community programming on site',
    ],
    cons: [
      'Standard layouts use communal bathrooms',
      'Older building infrastructure than ISR or Wassaja',
      'North-campus academic buildings are farther away',
    ],
    price: 13774,
    bathroomType: 'communal',
    floorPlans: [
