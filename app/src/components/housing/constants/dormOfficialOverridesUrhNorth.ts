...
export const URH_OFFICIAL_OVERRIDES_NORTH: Record<string, DormOverride> = {
  isr: {
    ...
    description:
      "ISR (Townsend and Wardall) sits beside the engineering-side campus and combines recently renovated traditional rooms, individual-use bathrooms, a large dining center, and program spaces.",
    pros: [
      "Walkable to engineering and north-campus classrooms",
      "Recently renovated commons, dining, and individual-use bathroom layouts",
      "Hosts Honors, Innovation, and Sustainability LLCs",
    ],
    cons: [
      "Rates are higher than older traditional halls",
      "Official inventory is concentrated in double and triple layouts",
      "South-campus recreation facilities take longer to reach",
    ],
    price: 14558,
  ...
  nugent: {
    ...
    description:
      "Nugent is a modern upper-division hall in Ikenberry Commons with large-window rooms, quick indoor access to SDRP dining, and the Business and Beckwith communities.",
    pros: [
      "Modern finishes and lounges",
      "Interior connection to SDRP dining",
      "Business LLC and Beckwith Residential Community on site",
    ],
    cons: [
      "Premium pricing within University Housing",
      "Engineering-side classes require a longer walk",
      "Some bathroom configurations vary by room type",
    ],
    price: 15042,
    bathroomType: "mixed",
    floorPlans: [
  ...
  wassaja: {
    ...
    description:
      "Wassaja is a quiet upper-division hall in Ikenberry Commons with clustered room layouts, updated finishes, and nearby SDRP dining.",
    pros: [
      "Modern finishes and lounges",
      "Mostly single and double layouts with individual-use bathrooms",
      "Convenient to SDRP and south-campus recreation",
    ],
    cons: [
      "Higher annual rate than traditional halls",
      "Limited room-layout variety",
      "North-campus classes take longer to reach",
    ],
    price: 15440,
    bathroomType: "mixed",
    floorPlans: [
  ...
  bousefield: {
    ...
    description:
      "Bousfield is a suite-style upper-division hall across from ARC and Memorial Stadium, with modern finishes and the Transfer Community.",
    pros: [
      "Suite-style layouts for sophomores through seniors",
      "Across the street from ARC and Memorial Stadium",
      "Transfer Community and apartment-like common spaces",
    ],
    cons: [
  ...
  par: {
    ...
    description:
      "PAR (Babcock, Carr, Blaisdell, and Saunders) combines in-hall dining, individual-use bathrooms, and two LLC communities in the south-campus residential area.",
    pros: [
      "Dining center inside the PAR complex",
      "Global Crossroads and Intersections LLCs",
      "Individual-use bathroom layouts in the residence complex",
    ],
    cons: [
      "South-campus location is far from north engineering",
      "Official room inventory is concentrated in singles and doubles",
      "Outdoor walk to the Quad takes longer than ISR or Allen",
    ],
    price: 14558,
    bathroomType: "individual-use",
    floorPlans: [
  ...
  far: {
    ...
    description:
      "FAR (Oglesby and Trelease) is a south-campus complex with in-hall dining, strong bus access, and the Women in Math, Science, and Engineering LLC.",
    pros: [
      "Dining is inside the FAR complex",
      "Frequent bus service at the halls",
      "WIMSE LLC and easy access to south-campus outdoor recreation",
    ],
    cons: [
      "Farther from the north side of campus",
      "Standard layouts rely on community bathrooms",
      "Fewer room types than newer upper-division halls",
    ],
    price: 14558,
  ...
  allen: {
    ...
    description:
      "Allen Hall houses the Unit One arts community and offers on-site creative spaces such as a music recording studio, darkroom, ceramics lab, and free music lessons.",
    pros: [
      "Unit One arts community with dedicated creative spaces",
      "In-hall dining plus an arts-focused program calendar",
      "Allen rooms are air-conditioned",
    ],
    cons: [
      "Communal bathrooms in standard layouts",
      "Older room layouts than ISR or Wassaja",
      "South-campus recreation is farther away",
    ],
    price: 13202,
    bathroomType: "communal",
    floorPlans: [
  ...
  "busey-evans": {
    ...
    dining: "nearby",
    diningNearbyDetail:
      "Residents use nearby University Housing dining locations rather than a hall dining room.",
    categorizedTags: {
    ...
    description:
      "Busey-Evans is a quieter, centrally located hall near the Music Building and Krannert Center, with lounge spaces and classical-revival architecture.",
    pros: [
      "Very close to the Music Building, Krannert, and the Quad",
      "Singles, doubles, and triples are available",
      "Quiet residential feel with patio and lounges",
    ],
    cons: [
      "No dining room inside the hall",
      "Older building systems than newly renovated halls",
