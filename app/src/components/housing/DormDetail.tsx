     ...
     "
				>
					<button
						...
						onClick={() => navigate("/dorms")}
						className="
        group flex items-center gap-1.5 py-2 text-slate-500 transition-colors
        hover:text-illini-blue
      "
					>
						<ArrowLeft
      ...
      "
					>
						{heroImage && (
							<div
								className="
          relative aspect-4/3 w-full cursor-zoom-in overflow-hidden bg-slate-100
          shadow-sm
          sm:aspect-video
        ...
        "
							...
							>
								...
								{positivePercent !== null && (
									<motion.button
										...
										className="
            absolute top-3 right-3 flex cursor-pointer items-center gap-1
            rounded-full border border-white/50 bg-white/80 px-2.5 py-1
          ...
          "
           ...
           "
										...
										<div
											className="
             absolute right-3 bottom-3 rounded-full bg-black/40 px-2.5 py-1
												...
												return dorm.categorizedTags.llcNames!.map(
													(llcName, j) => (
														<motion.span
															...
															className="
                 inline-flex items-center gap-1 rounded-full bg-illini-orange/10
                 px-3 py-1 text-[12px] font-bold text-illini-orange
                 md:text-[13px]
               "
														>
															{Icon && (
         ...
         `}
           ...
           `}
            ...
            "
											>
												<div
													className="h-[2px] w-[140%] rotate-45 rounded-full bg-red-400"
												/>
											</div>
										)}
									</div>
         ...
         "
          ...
          "
						...
						<div className="space-y-3 pt-2">
							<p
								className="
          max-w-4xl text-[14px] leading-relaxed font-medium text-slate-600
          md:text-[15px]
        "
							>
								{dormDesc}
							...
							{(dorm.website || dorm.housingType === "URH") && (
								<a
									...
									className="
           inline-flex w-fit items-center gap-1 rounded-full bg-slate-100 px-3
           py-1.5 text-[11px] font-semibold text-slate-500 transition-colors
           hover:bg-slate-200
           md:text-[12px]
         "
								>
								...
								{neutralTags.map((tag, i) => {
									...
									return (
										<motion.div
											...
											className="
             flex cursor-default items-center gap-1.5 rounded-lg border
             border-white/60 bg-white/80 px-2.5 py-1
								...
								{mutedTags.map((tag, i) => {
									...
									return (
										<motion.div
											...
											className="
             flex cursor-default items-center gap-1.5 rounded-lg border
             border-slate-200/50 bg-slate-100/50 px-2.5 py-1
             md:rounded-xl md:px-3 md:py-1.5
           "
										>
											{Icon && (
        ...
        "
         ...
         "
          ...
          "
								...
								<motion.button
									...
									className={`
           flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-[12px]
           font-bold shadow-[0_2px_10px_rgba(0,0,0,0.02)] backdrop-blur-md
           transition-all
         ...
         `}
          ...
          "
             ...
             border-slate-100 bg-white shadow-sm transition-shadow duration-150
             hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(0,0,0,0.08)]
             md:rounded-2xl
           "
										>
											<div
            ...
            "
											>
												...
												<div
													className="
               relative size-20 shrink-0 overflow-hidden rounded-lg border
               border-slate-200/60 bg-slate-50 transition-colors
             ...
             "
               ...
               "
														...
														<div
															className="
                 flex size-full items-center justify-center text-slate-300
               "
														>
															<SquareDashed
																className="size-8"
             ...
             "
												>
													...
													<div
														className="
                flex h-full min-w-0 flex-col justify-center gap-1.5 py-0.5
                md:gap-3
              "
													>
														<div
               ...
               "
                ...
                "
															>
																<h4
																	className="
                   truncate text-[15px] font-extrabold text-slate-900
                   md:text-[18px]
                 "
																>
																	{planDisplayTitle}
                  ...
                  "
                   ...
                   md:gap-1 md:rounded-xl md:px-2.5 md:py-1 md:text-[13px]
                   ${
																			plan.available === false
                 ...
                 `}
                    ...
                    "
															...
															<motion.div
																...
																className="
                  -mr-1 flex shrink-0 items-center justify-center text-slate-400
                  md:hidden
                "
															>
               ...
               "
                ...
                "
															>
																<span
																	className="
                   text-[16px] font-extrabold tracking-tight text-slate-900
                   tabular-nums
                 "
																>
																...
																<span
																	className="
                   ml-1 text-[11px] font-medium text-slate-400 tabular-nums
                 "
																>
                ...
                `}
														...
														{showPlanCompare && (
															<motion.button
																...
																className={`
                  mt-1 flex items-center gap-1.5 rounded-lg border px-2.5 py-1
                ...
                `}
                 ...
                 `}
													...
													<div
														className="
                hidden h-full shrink-0 flex-col items-end justify-between gap-2
                py-0.5
                md:flex
              "
													>
														{planPrice != null ? (
															<div className="flex flex-col items-end">
																<div className="flex items-baseline gap-0.5">
																	<span
																		className="
                    text-[24px] font-extrabold tracking-tight text-slate-900
                    tabular-nums
                  "
																	>
																		{formatPrice(planPrice)}
																...
																<div
																	className="
                   mt-1 inline-flex items-center rounded-md bg-slate-100 px-1.5
                   py-0.5 text-[12px] font-medium text-slate-500 tabular-nums
                 "
																>
																	~{formatPrice(Math.round(planPrice / 12))}
																	{t.mo}
                 ...
                 "
																>
																	<img
																		...
																		className="
                    h-auto w-full cursor-zoom-in rounded-xl border
                    border-slate-200/50 bg-slate-50 transition-opacity
                    hover:opacity-90
                  "
																		onClick={(e) => {
																			e.stopPropagation();
																	...
																	{allExpandedImages.length > 1 && (
																		<>
																			...
																			<div
																				className="
                      absolute right-3 bottom-3 rounded-full bg-black/40 px-2.5
                      py-1 text-[11px] font-semibold text-white backdrop-blur-sm
                    "
																			>
																				{safeExpandedIndex + 1} /{" "}
																				{allExpandedImages.length}
																...
																<div
																	className="
                   mt-3 flex items-center justify-center rounded-xl border
                   border-dashed border-slate-200/50 bg-slate-50/50 p-6
								...
								{showPlanCompare &&
									...
									(() => {
										const compared = compareIds
											...
											.filter(
												(x): x is { plan: FloorPlan; idx: number } =>
													x !== null,
											);
										...
										return (
											...
											>
												<div
													className="
               overflow-x-auto rounded-xl border border-illini-blue/20 bg-white
             ...
             "
              ...
              "
               ...
               "
														...
														<span
															className="ml-auto text-[12px] font-medium text-slate-400"
														>
															{compared.length}{" "}
														...
														<tbody>
															{rows.map((row, ri) => (
																...
																>
																	<td
																		className="
                    w-[100px] border-r border-slate-100 px-4 py-2.5
                    font-semibold whitespace-nowrap text-slate-500
                  ...
                  "
																	...
																	{row.values.map((val, ci) => (
																		<td
																			key={ci}
																			className="
                     min-w-[100px] border-r border-slate-100 px-3 py-2.5
           ...
           border-white/50 bg-white/60 p-4 shadow-[0_4px_20px_rgba(0,0,0,0.02)]
           backdrop-blur-md
         ...
         "
								...
								<div className="mt-2.5 flex justify-end">
									<motion.button
										...
										whileTap={{ scale: 0.97 }}
										className="
            rounded-xl bg-illini-blue px-5 py-2 text-[13px] font-bold text-white
            transition-colors
            hover:bg-illini-blue/90
            disabled:opacity-40
            md:text-[14px]
          "
            ...
            "
                ...
                "
													...
													<div className="flex items-center gap-2">
														{comment.dorm_vote === 1 && (
															<div
																className="
                  flex items-center gap-1 rounded-lg bg-illini-orange/10 px-2
                  py-1
                "
															>
																<ThumbsUp
																	className="size-3 fill-illini-orange text-illini-orange"
																/>
																<span
																	className="text-[11px] font-bold text-illini-orange"
																>
																	{t.recommended}
																</span>
															</div>
              ...
              "
												...
												<div
													className="
               mt-4 flex items-center gap-4 border-t border-slate-100/50 pt-3
             "
												>
													<motion.button
														type="button"
       ...
       bg-illini-blue px-4 py-2.5 text-[13px] font-bold text-white shadow-lg
       transition-colors
       hover:bg-illini-blue/90
     "
				>
