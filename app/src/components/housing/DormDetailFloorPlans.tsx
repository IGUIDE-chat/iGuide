            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          className={`
                            ...
                            py-0.5 text-[10px] font-bold whitespace-nowrap
                      ...
                      <motion.div
                        ...
                        className="
                          -mr-1 flex shrink-0 items-center justify-center
                          text-slate-400
                          md:hidden
                        "
                      >
                    ...
                    {showPlanCompare && (
                      <motion.button
                        ...
                        className={`
                          mt-1 flex items-center gap-1.5 rounded-lg border
                  ...
                  <div
                    className="
                      hidden h-full shrink-0 flex-col items-end justify-between
                      gap-2 py-0.5
                      md:flex
                    "
                  >
                      ...
                      <div className="flex flex-col items-end">
                        ...
                        <div
                          className="
                            ...
                            bg-slate-100 px-1.5 py-0.5 text-[12px] font-medium
                    ...
                    <div className="flex items-center gap-3">
                      {showPlanCompare && (
                        <motion.button
                          ...
                          className={`
                            flex items-center gap-1.5 rounded-lg border px-3
                      ...
                      {hasExpandedImage ? (
                          ...
                          {allExpandedImages.length > 1 && (
                            <>
                              <button
                                ...
                                className="
                                  absolute top-1/2 left-3 z-10 flex size-9
                                  -translate-y-1/2 items-center justify-center
                                  rounded-full bg-black/35 text-white
                              ...
                              <button
                                ...
                                className="
                                  absolute top-1/2 right-3 z-10 flex size-9
                                  -translate-y-1/2 items-center justify-center
                                  rounded-full bg-black/35 text-white
                                  backdrop-blur-sm transition-colors
                                  hover:bg-black/55
                        ...
                        <div
                          className="
                            ...
                            bg-slate-50/50 p-6 text-[13px] font-medium
                            text-slate-400
