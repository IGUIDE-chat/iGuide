				...
				<div className="fixed inset-0 overflow-y-auto">
					...
					>
						...
						>
							<Dialog.Panel
								className="
          flex max-h-[85vh] w-full max-w-2xl transform flex-col overflow-hidden
          rounded-2xl bg-white text-left align-middle shadow-2xl
        "
							>
								<div
									className="
         ...
         "
          ...
          "
								...
								<div
									...
									className="
           scrollbar-grey modal-scroll-smooth flex-1 overflow-y-auto p-6
         "
								>
									<ChipSection
										title={t.location}
            ...
            `}
              ...
              `}
								...
								<div
									className={`
           z-10 flex items-center justify-between border-t border-gray-100
           bg-white px-6 py-4 transition-shadow duration-300
           ${
											showFooterShadow
         ...
         `}
								>
									<button
										...
										type="button"
										className="
            text-sm font-bold text-gray-900 underline transition-colors
