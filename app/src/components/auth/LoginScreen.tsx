   ...
   "
    ...
    "
			>
				<button
					...
					className="
       flex items-center gap-2 rounded-full border border-slate-200 bg-white/80
       px-3 py-2 text-sm font-semibold text-slate-600 shadow-sm backdrop-blur-md
       transition-all
    ...
    "
			>
				...
				{/* Toggle */}
				<div
					className="relative isolate mb-6 flex gap-2 rounded-full bg-slate-100 p-1"
				>
					<button
      ...
      "
				...
				<form onSubmit={handleSubmit} className="space-y-4">
					<div>
						...
						<input
							...
							className="
         w-full rounded-xl border-2 border-slate-200 bg-slate-50 px-4 py-3
         transition-all
       ...
       "
					...
					{error && (
						<div
							className="
         flex items-center gap-2 rounded-xl border border-red-200 bg-red-50 p-3
       ...
       "
					...
					<button
						...
						disabled={loading}
						className="
        w-full rounded-xl bg-illini-blue py-3.5 text-lg font-bold text-white
        shadow-lg shadow-illini-blue/20 transition-all
