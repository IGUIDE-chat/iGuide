      ...
      "
       ...
       "
						...
						{isEditing ? (
							<div className="mb-2 flex w-full max-w-[200px] items-center gap-2">
								<input
									...
									className="
           w-full border-b-2 border-illini-orange bg-transparent px-3 py-1
        ...
        "
         ...
         "
								...
								<button
									...
									disabled={isLoading}
									className="
           rounded-full bg-illini-orange px-4 py-1.5 text-xs font-medium
        ...
        "
							...
							<div
								className="
          rounded-lg border border-slate-100 bg-slate-50 p-3 text-sm font-medium
          text-slate-700
        "
							>
								{user.email}
					...
					{isSoulEditing ? (
						<>
							<textarea
								...
								className="
          w-full resize-none rounded-lg border border-slate-200 bg-slate-50 p-3
          text-sm text-slate-700
          focus:border-illini-orange focus:ring-2 focus:ring-illini-orange/30
          focus:outline-none
        "
							/>
          ...
          "
						...
						<div
							className="
         min-h-[60px] rounded-lg border border-slate-100 bg-slate-50 p-3 text-sm
         text-slate-600
       "
						>
							{soul || (
       ...
       "
				...
				<button
					...
					className="
       group flex w-full items-center justify-center gap-2 rounded-xl bg-red-50
       py-3.5 font-semibold text-red-600 transition-colors
       hover:bg-red-100
     "
				>
					<svg
