     ...
     "
					...
					<form onSubmit={handleSubmit} className="space-y-5">
						...
						<div>
							...
							<input
								...
								className="
          w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3
          text-slate-900 placeholder-slate-400 transition-all
          focus:border-illini-blue focus:ring-2 focus:ring-illini-blue/50
          focus:outline-none
        "
        ...
        "
						...
						<div className="flex items-center">
							<input
								...
								className="
          size-4 rounded-sm border-slate-300 bg-slate-50 text-illini-blue
        ...
        "
						...
						<button
							...
							disabled={isLoading}
							className="
         w-full rounded-lg bg-illini-blue px-4 py-3 font-semibold text-white
