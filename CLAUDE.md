...
This project is indexed by GitNexus as **iGuide** (5598 symbols, 9024 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| `gitnexus://repo/iGuide/process/{name}` | Step-by-step execution trace |
