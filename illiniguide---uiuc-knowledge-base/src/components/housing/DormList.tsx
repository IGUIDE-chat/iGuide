      ...
      <AnimatePresence>
        {compareIds.length > 0 && (
          <motion.div
            ...
            className="fixed bottom-6 left-4 right-4 mx-auto w-fit z-50 flex items-center gap-2 md:gap-3 rounded-full bg-illini-blue px-3 md:px-5 py-2.5 md:py-3 text-white shadow-xl max-w-[calc(100vw-2rem)]"
          >
