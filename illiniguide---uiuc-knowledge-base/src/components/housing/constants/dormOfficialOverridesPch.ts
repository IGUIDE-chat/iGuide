    ...
    'illini-tower': {
        ...
        floorPlans: [
            plan({
                ...
                sqft: 465,
                price: 25850,
                imageUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/10/S1.jpg'),
                photoUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/10/S1-Gallery.jpg'),
            ...
            plan({
                ...
                bathroomScope: 'private',
                sqft: 560,
                imageUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/10/S2.jpg'),
                photoUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/10/S2-Gallery.jpg'),
                description: 'Private studio with kitchenette.',
                available: false,
            }),
            plan({
                ...
                sqft: 630,
                price: 12500,
                imageUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/11/B1-Shared.jpg'),
                photoUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/11/B1-Shared-Gallery.jpg'),
            ...
            plan({
                ...
                sqft: 700,
                price: 12500,
                imageUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/10/B2-Shared.jpg'),
                photoUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/10/B2-Shared-Gallery.jpg'),
                description: 'Two-bedroom apartment; annual rate is published per bed.',
            }),
            plan({
                ...
                bathroomScope: 'semi-private',
                sqft: 700,
                imageUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/10/B2-Private.jpg'),
                photoUrls: urls('https://wp.propertyjs.app/illini-tower/wp-content/uploads/sites/10/2024/10/B2-Private-Gallery.jpg'),
                description: 'Two-bedroom apartment; private bedroom layout. Annual rate is published per person when available.',
                available: false,
            }),
            plan({
                officialName: 'C1',
    ...
    newman: {
        ...
        floorPlans: [
            ...
            plan({
                ...
                description: 'Updated traditional-style South single room with communal bathrooms and premium amenities.',
            }),
            plan({
                ...
                description: 'North double suite with two shared bedrooms, a shared living room, and a suite bathroom.',
            }),
            plan({
            ...
            plan({
                ...
                description: 'North semi-private single with a dedicated bedroom and shared suite bathroom access.',
            }),
        ],
    },
    hendrick: {
        ...
        floorPlans: [
            ...
            plan({
                ...
                bathroomScope: 'semi-private',
                price: 24450,
                imageUrls: urls('https://www.hendrickhouse.com/wp-content/uploads/2019/05/Deluxe_Double.jpg'),
                photoUrls: urls(
                    'https://www.hendrickhouse.com/wp-content/uploads/2019/04/2.jpg',
                    'https://www.hendrickhouse.com/wp-content/uploads/2019/04/16.jpg'
                ),
    ...
    armory: {
        ...
        floorPlans: [
            plan({
                ...
                description: 'Main double with suite-style bathroom sharing and the published 10-meal plan rate.',
            }),
            plan({
                officialName: 'Deluxe Double',
                bedCount: 2,
                ...
                bathroomScope: 'semi-private',
                price: 15350,
                imageUrls: urls('https://www.armoryhouse.com/sites/default/files/2020-02/floorplan-deluxe_2.jpg'),
                photoUrls: urls(
            ...
            plan({
                ...
                photoUrls: urls('https://www.armoryhouse.com/sites/default/files/inline-images/DSC05624.JPG'),
            ...
            plan({
                ...
                description: 'Main single with suite-style bathroom sharing and the published 10-meal plan rate.',
            }),
            plan({
                ...
                bathroomCount: 1,
                bathroomScope: 'semi-private',
                imageUrls: urls('https://www.armoryhouse.com/sites/default/files/2020-02/AH%20Suite3d%20F8_0.jpg'),
                photoUrls: urls('https://www.armoryhouse.com/sites/default/files/inline-images/DSC05144_1.JPG'),
                description: 'Standard single suite. Armory publishes this in a grouped Suite & Corner Single rate bucket.',
            }),
            plan({
                ...
                bathroomCount: 1,
                bathroomScope: 'semi-private',
                imageUrls: urls('https://www.armoryhouse.com/sites/default/files/2020-02/AH%20Suite3d%20F8_1.jpg'),
                photoUrls: urls('https://www.armoryhouse.com/sites/default/files/inline-images/Suites%20Corner%20Room.jpg'),
                description: 'Corner single suite. Armory publishes this in a grouped Suite & Corner Single rate bucket.',
            }),
        ],
    },
};
