...
export const registerMapAssets = (map: mapboxgl.Map) => {
    if (!map.hasImage('pill')) {
        ...
        if (pillImage) {
            map.addImage('pill', pillImage, { pixelRatio: 2, stretchX: [[40, 80]], stretchY: [[20, 40]] });
        }
    }
    ...
    if (!map.hasImage('pill-active')) {
        ...
        if (activePillImage) {
            map.addImage('pill-active', activePillImage, { pixelRatio: 2, stretchX: [[40, 80]], stretchY: [[20, 40]] });
        }
    }
