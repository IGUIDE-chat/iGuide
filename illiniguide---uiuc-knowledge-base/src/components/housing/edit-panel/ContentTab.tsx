...
import { LOCATION_PRESETS } from '../../../constants/housing/metadata';
            ...
            {form.contentLang === 'en' ? (
                <>
                    ...
                    <Field label={t.labels.cons}>
                        <EditableList items={form.cons} onChange={form.setCons} placeholder={t.actions.addCon} />
                    </Field>
                </>
            ) : (
                <>
                    ...
                    <Field label={t.labels.cons}>
                        <EditableList items={form.consZh} onChange={form.setConsZh} placeholder={t.actions.addCon} />
                    </Field>
                </>
            )}
