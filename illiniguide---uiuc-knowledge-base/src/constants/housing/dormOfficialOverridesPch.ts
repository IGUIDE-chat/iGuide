...
export const PCH_OFFICIAL_OVERRIDES: Record<string, DormOverride> = {
    bromley: {
        ...
        description: 'Bromley is a fully air-conditioned private certified hall with large rooms, adjoining semi-private bathrooms, all-inclusive dining, and a broad amenity package.',
        pros: ['All-inclusive meal plan on site', 'Some of the largest rooms among UIUC residence halls', 'Semi-private bathrooms and amenities like a pool and rooftop spaces'],
        cons: ['Rates rise quickly for singles and deluxe doubles', 'Greek-adjacent social reputation may not fit every student', 'Bathroom access is shared rather than fully private'],
        price: 13744,
    ...
    'illini-tower': {
        ...
        imageUrl: 'https://certified.housing.illinois.edu/wp-content/uploads/2021/01/IT-Featured-Photo-on-Website.jpg',
        galleryImages: urls(
        ...
        description: 'Illini Tower is a furnished private certified option two blocks from the Quad, with on-site dining, kitchens in multi-bedroom units, and a pet-friendly policy.',
        pros: ['Apartment-style units with kitchens', 'On-site dining and study/lounge spaces', 'One of the few pet-friendly student-residence options'],
        cons: ['Rates differ significantly by layout and occupancy', 'Older high-rise circulation can mean elevator dependence', 'Shared in-unit bathrooms for most multi-bedroom plans'],
        price: 12500,
        bathroomType: 'semi-private',
        floorPlans: [
            plan({
                officialName: 'S1 / S2 Studio',
                labelCode: 'Studio',
                bedCount: 1,
                bathroomCount: 1,
                ...
                description: 'Studio with kitchenette.',
            }),
            plan({
                officialName: 'B1 Shared / B2 Shared / B2 Private',
                bedCount: 2,
                bathroomCount: 1,
                bathroomScope: 'semi-private',
                sqft: 320,
    ...
    newman: {
        ...
        description: 'Newman Hall combines traditional and suite-style housing a few steps from the Quad, with fresh dining, a large student community, and updated rooms.',
        pros: ['Very close to the Quad and Green Street', 'On-site dining and strong community programming', 'Both traditional and suite-style room types are available'],
        cons: ['Published rates vary by hall side, room style, and meal plan', 'Most private bedrooms still share a suite bathroom', 'Religious-center setting may not fit every student'],
        price: 15725,
        bathroomType: 'semi-private',
        floorPlans: [
            plan({
                ...
                description: 'South double traditional room with meal plan pricing.',
            }),
            plan({
                ...
                description: 'South triple traditional room with meal plan pricing.',
            }),
            plan({
            ...
            plan({
                officialName: 'North Single Suite / South Single Room',
                bedCount: 1,
                bathroomCount: 1,
                bathroomScope: 'semi-private',
                sqft: 125,
                ...
                description: 'Single room inventory across South or North suite-style options.',
            }),
        ],
    },
    hendrick: {
        ...
        description: 'Hendrick House sits near the engineering side of campus and pairs large rooms and semi-private baths with a dining program that the property highlights heavily.',
        pros: ['Close to engineering-side academic buildings', 'Semi-private baths in many rooms', 'Dining is a major differentiator and is on site'],
        cons: ['Upper-end singles are expensive', 'Less central for the Main Quad and Campustown than Newman or Bromley', 'Room inventory is concentrated in doubles and singles'],
        price: 14550,
        bathroomType: 'semi-private',
        floorPlans: [
            plan({
            ...
            plan({
                ...
                description: 'East deluxe double with two private bedrooms, a shared lounge, and one shared bathroom; annual rate shown for the 14-meal academic-year contract.',
            }),
            plan({
                ...
                description: 'East single private room with a semi-private bath; annual rate shown for the 14-meal academic-year contract.',
            }),
            plan({
                ...
                photoUrls: urls(
                    'https://www.hendrickhouse.com/wp-content/uploads/2019/04/18-1024x768.jpg',
                    'https://www.hendrickhouse.com/wp-content/uploads/2019/04/16-1024x768.jpg'
                ),
                description: 'West single private room with a semi-private bath; annual rate shown for the 14-meal academic-year contract.',
            }),
        ],
    },
    presby: {
        ...
        applicationFee: 0,
        imageUrl: 'https://certified.housing.illinois.edu/wp-content/uploads/2015/07/Presby-Gallery1-409x270-1.jpg',
        galleryImages: urls(
        ...
        dining: 'inside',
        diningNearbyDetail: 'Presby publishes room and board separately; a meal plan is required by the University.',
        bathroomType: 'semi-private',
        categorizedTags: {
            livingConditions: [],
        ...
        description: 'Presby Hall offers suite-style private certified housing with living rooms, kitchens, two bathrooms per suite, and an on-site parking garage.',
        pros: ['Suite layouts include kitchens and living rooms', 'No application fee and on-site garage parking', 'Published room-only and board pricing offers flexibility'],
        cons: ['Certified-housing directory totals do not align perfectly with the room-only rate sheet', 'Bathroom sharing depends on suite assignment', 'Amenity photography is less detailed than some newer properties'],
        price: 11775,
        floorPlans: [
            plan({
                officialName: 'Standard Double',
    ...
    armory: {
        ...
        galleryImages: urls(
            ...
            'https://www.armoryhouse.com/sites/default/files/styles/photo_side_by_side/public/2020-01/suite-house.jpg?itok=qIGtlb3K',
            'https://www.armoryhouse.com/sites/default/files/styles/photo_side_by_side/public/2020-02/3%20%281%29_1.jpg?itok=6yIqWlyt',
            'https://www.armoryhouse.com/sites/default/files/styles/photo_side_by_side/public/2020-02/6_2.jpg?itok=gngUUxuJ',
            'https://www.armoryhouse.com/sites/default/files/styles/photo_side_by_side/public/2020-02/parking.jpg?itok=RLnlL6sb'
        ),
        dining: 'inside',
        diningNearbyDetail: 'Armory House Kitchen is part of the property and publishes room-and-meal pricing together.',
        bathroomType: 'semi-private',
        categorizedTags: {
            livingConditions: [],
        ...
        description: 'Armory House is a private certified option near the south edge of campus with a globally oriented residential program, on-site dining, and both main-room and suite inventory.',
        pros: ['Wide mix of singles, doubles, and suite inventory', 'On-site dining plus gym, laundry, and parking', 'Property explicitly markets an international student community'],
        cons: ['Some certified-housing summary rates differ slightly from the detailed property page', 'Bathroom privacy depends on whether the room is in the main building or a suite', 'More expensive single options rise quickly'],
        price: 14000,
        floorPlans: [
            plan({
                ...
                description: 'Main double with 10-meal plan.',
            }),
            plan({
                ...
                description: 'Suite double with 10-meal plan.',
            }),
            plan({
            ...
            plan({
                officialName: 'Suite / Corner Single',
                bedCount: 1,
                bathroomCount: 1,
                bathroomScope: 'semi-private',
                sqft: 220,
